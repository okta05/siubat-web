            ...
            <div class="table-responsive table-striped">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td>
                            @if($user->foto)
                            <img src="{{asset('storage/'. $user->foto)}}" alt="" title="{{$user->foto}}"
                                class="card-img-top" style="width: 100px; display: block;">
                            @else
                            <img src="{{asset('backend/img/no-image.jpg')}}" alt="" title="Tidak ada gambar."
                                class="card-img-top" style="width: 100px; display: block;">
                            @endif
                        </td>
